...
export class TablePattern extends React.Component {
    render() {
        return (<PatternGroup name='Table'>
                ...
                <Pattern name='SimpleTable'>
                    ...
                    <CodeEditor codeText={CodeSamples.SimpleTable}/>
                </Pattern>
                <Pattern name='TableRowGrouping'>
                    <Description>Table with row grouping</Description>
                    <CodeEditor codeText={CodeSamples.TableRowGrouping}/>
                </Pattern>
                <Pattern name='TableCustomComponentInCell'>
                    <Description>Table with custom component in cell - using the neptune button component in this example</Description>
                    <CodeEditor codeText={CodeSamples.TableCustomComponentInCell}/>
                </Pattern>
                <Pattern name='Table'>
                    <Description>Default Table</Description>
                    <CodeEditor codeText={CodeSamples.Table}/>
                </Pattern>
                <Pattern name='TableObjectData'>
                    <Description>Table with object data</Description>
                    <CodeEditor codeText={CodeSamples.TableObjectData}/>
                </Pattern>
                <Pattern name='TableLockedColumn'>
                    <Description>Table with locked columns</Description>
                    <CodeEditor codeText={CodeSamples.TableLockedColumn}/>
                </Pattern>
                <Pattern name='TableCellHtml'>
                    <Description>Table with custom cell rendering</Description>
                    <CodeEditor codeText={CodeSamples.TableCellHtml}/>
                </Pattern>
                <Pattern name='TableCallback'>
                    <Description>Table with callback</Description>
                    <CodeEditor codeText={CodeSamples.TableCallback}/>
                </Pattern>
                <Pattern name='TableFixedHeader'>
                    <Description>Table with fixed header</Description>
                    <CodeEditor codeText={CodeSamples.TableFixedHeader}/>
                </Pattern>
                <Pattern name='TableSortField'>
                    <Description>Table with separate sort field</Description>
                    <CodeEditor codeText={CodeSamples.TableSortField}/>
                </Pattern>
